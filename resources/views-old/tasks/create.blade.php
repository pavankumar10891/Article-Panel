...
<script src="https://cdn.ckeditor.com/4.21.0/standard/ckeditor.js"></script>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                {!! Form::open(array('route' => 'tasks.store','method'=>'POST', 'files'=> true)) !!}
                <div class="row mb-3">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6"> 
                        <div class="form-group">
                            ...
                            {!! Form::select('priority', ['1'=>'Normal','2'=>'High', '3'=>'Urgent',],[], array('class' => 'form-control selectpicker')) !!}
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                             ...
                             {{ Form::textarea("guideline",'', ['class' => 'form-control form-control-solid form-control-lg','id' => 'guideline']) }}
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                             ...
                             {{ Form::textarea("content",'', ['class' => 'form-control form-control-solid form-control-lg','id' => 'content']) }}
                        </div>
                        @if ($errors->has('operator_email'))
                                <span class="invalid feedback"role="alert">
                                    <strong>{{ $errors->first('operator_email') }}.</strong>
