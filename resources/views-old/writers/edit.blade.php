    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <hr class="my-0" />
                <div class="card-body">
                    {!! Form::model($user, ['route' => ['writers.edit', $user->id], 'method'=>'POST', 'files' => true]) !!}
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('ppw', null, array('placeholder' => 'Ppw','class' => $errors->has('ppw') ? 'form-control is-invalid':'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-sm-6"> 
                                <div class="form-group">
